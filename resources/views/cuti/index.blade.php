                                    ...
                                    <div class="row">
                                        <div class="col-10">
                                            <div class="form-group">
                                                <input type="text" name="nama_cuti" id="nama_cuti" class="form-control" placeholder="Nama Cuti" value="{{ Request('nama_cuti') }}">
                                            </div>
                                        </div>
                                        <div class="col-2">
                                            <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="input-icon mb-3">
                                ...
                                <input type="text" id="kode_cuti" class="form-control" placeholder="Kode Cuti" name="kode_cuti">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
                            <div class="input-icon mb-3">
                                ...
                                <input type="text" id="nama_cuti_input" class="form-control" name="nama_cuti" placeholder="Nama Cuti">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
                            <div class="input-icon mb-3">
                                ...
                                <input type="number" id="jml_hari" class="form-control" name="jml_hari" placeholder="Jumlah Hari Cuti">
                            </div>
                        </div>
                    </div>
...
<script>
    $(function() {
        ...
        $("#frmCuti").submit(function() {
            ...
            var nama_cuti = $("#nama_cuti_input").val();
